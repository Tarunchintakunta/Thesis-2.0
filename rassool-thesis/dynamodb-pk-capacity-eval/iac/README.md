# Terraform — dynamodb-pk-capacity

Portable research IaC for the **DynamoDB PK × capacity** AWS evaluation surface.
...
## Usage
```bash
cd rassool-thesis/dynamodb-pk-capacity-eval/iac
terraform init
terraform plan
terraform apply
# after campaigns:

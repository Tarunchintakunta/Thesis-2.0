...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Leg 3 (Overhead):} Measure telemetry volume, latency impact, and estimated cost on live AWS --- \textbf{not executed} in this submission (\texttt{results/live/} absent)
    \end{itemize}
...
Committed Leg~2 evidence does not yet support a within-10\,pp competitiveness claim; live AWS Leg~3 remains required for the overhead half of the CA2 decision rule.

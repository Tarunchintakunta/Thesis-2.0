...
\begin{enumerate}
    ...
    \item \textbf{Open Artefact and Dataset:} The entire artefact (SAM template, simulator, experiment runner, analysis scripts, tests, manifests) is committed to the repository with reproducible build instructions. The 350+ experimental run manifests and 11 figures constitute a reusable dataset for validating alternative analysis approaches or extending to other fault types.
\end{enumerate}

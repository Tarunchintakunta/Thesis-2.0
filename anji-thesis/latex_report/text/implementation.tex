...
Pilot (18 runs, 1000 messages each) estimated at \$0.10. Full experiments (350+ runs, 10,000 messages each) estimated at \$50-100 by \texttt{estimate\_cost.py}. These are \textbf{estimator projections only}---no live AWS spend occurred and no experimental cost DV is in \texttt{results/summary/}. Simulator avoids all charges.

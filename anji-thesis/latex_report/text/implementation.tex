...
Pilot (18 design runs) estimated at \$0.10. Full design matrix (350 unique cells) estimated at \$50-100 by \texttt{estimate\_cost.py}. These are \textbf{estimator projections only}---no live AWS spend occurred and no experimental cost DV is in \texttt{results/summary/}. Simulator avoids all charges.
...
\begin{itemize}
    ...
    \item \textbf{Simulator-first development:} Rapid iteration without AWS costs; enabled the 350 unique design cells in minutes.

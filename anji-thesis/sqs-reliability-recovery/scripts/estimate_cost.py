...
safety factor (no local simulator). Does not block the live runner.
"""
...
from control.cost_guard import estimate_plan  # noqa: E402
...
def main(argv=None) -> int:
    ...
    print(f"estimated cost      : ${est['usd_total']:.4f}  (x{est['safety_factor']:.0f} safety factor)")

...
Table~\ref{tab:results} reports mean $\pm$ standard deviation across 5 seeds (42-46) on a pooled, held-out test set drawn from all 6 sites, bound to \texttt{results/results\_summary.csv} (per-seed rows in \texttt{results\_per\_seed.csv}).

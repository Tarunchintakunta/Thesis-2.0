...
\textbf{Important:} Experiments use local Dask \texttt{LocalCluster} on one host. This is \textbf{not} the CA2 AWS EC2 matched-vCPU multi-instance campaign. Local results are a proxy only; no live EC2 metrics are claimed.

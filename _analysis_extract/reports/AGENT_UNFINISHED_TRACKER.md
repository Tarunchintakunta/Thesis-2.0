...
| SOT-RESTORE | Branch churn dropped uncommitted SoTs | Restore SoTs + audits EXIT 0 | **IN_PROGRESS** — pending **Uday/Anji** only (Mehak/Vish/Chaitanya/Yash/Nemi/Pooja done) |
...
**Runtime:** 43h 34m 3s  
**Remediable tracker rows:** soft N CLOSED; **SOT-RESTORE IN_PROGRESS** (Uday/Anji still pending).  

...
| SOT-RESTORE | Branch churn dropped uncommitted SoTs | Restore SoTs + audits EXIT 0 | **CLOSED** — all 12 non-Kasi SoTs + scripted audits on `cursor/rasool-ca2-sot-audit-9837` |
...
**Runtime:** 43h 34m 3s  
**Remediable tracker rows:** soft N CLOSED; **SOT-RESTORE CLOSED** (12/12 SoTs).  

...
**COMPLETE decision:** Live metered FL on EC2 with S3 parameter persistence and CloudWatch telemetry answers the sole AWS residual at floor depth. Longer campaigns and orchestrators are a stronger thesis path, not a gate.

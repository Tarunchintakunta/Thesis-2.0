...
\subsubsection{Future deployment modes (not executed)}

No Docker Compose file, Helm chart, or live AWS deployment was executed for this evaluation. A Terraform scaffold exists under \texttt{securefl-ids/terraform/} but has \textbf{not} been applied. Any container or cloud orchestration remains future work after the alignment-first gate.

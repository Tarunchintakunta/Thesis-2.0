...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Local multi-process simulation (30-round campaigns)
        \item Unit tests and experiment scripts
        \item Live AWS lite FL under \texttt{securefl-ids/terraform/} (applied then destroyed; no Docker/K8s claim)
    \end{itemize}
\end{enumerate}

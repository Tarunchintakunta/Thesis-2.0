...
\textbf{Formal CA2 suite} (required on GCT; wired here on synthetic features for harness completeness):
\begin{itemize}
...
Classical RF/KNN/SVM monitors are fit on flattened history windows as scaffold traditional baselines. A full Aldomi-style~\cite{Aldomi26} SelectKBest+GRU hybrid on GCT feature schemas remains blocked on missing traces. All reported scalars are mean $\pm$ std across seeds 42--46 on synthetic data only.

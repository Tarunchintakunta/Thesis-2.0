...
Source: `mhsa-tdl-framework/results/gct/results_summary.csv`. Dataset flag: **gct**.  
...
| RF (classical) | 0.944 ± 0.002 | 0.881 ± 0.009 | 0.609 ± 0.011 | 0.670 ± 0.013 | 0.812 ± 0.052 | 0.515 ± 0.031 | 0.276 |
| KNN (classical) | 0.932 ± 0.003 | 0.824 ± 0.024 | 0.551 ± 0.012 | 0.594 ± 0.017 | 0.701 ± 0.071 | 0.359 ± 0.033 | 0.048 |
| SVM (classical) | 0.923 ± 0.001 | 0.718 ± 0.031 | 0.505 ± 0.007 | 0.522 ± 0.012 | — | 0.339 ± 0.008 | 0.112 |
| MHSA-PerHead | 0.921 ± 0.002 | 0.678 ± 0.011 | 0.584 ± 0.005 | 0.615 ± 0.006 | 0.571 ± 0.110 | 0.409 ± 0.018 | 0.005 |
| MHSA-Fused | 0.922 ± 0.002 | 0.684 ± 0.008 | 0.581 ± 0.006 | 0.613 ± 0.006 | 0.617 ± 0.105 | 0.412 ± 0.016 | 0.005 |
| Aldomi GRU-RF | 0.943 ± 0.001 | 0.833 ± 0.009 | 0.620 ± 0.006 | 0.676 ± 0.005 | 0.753 ± 0.128 | 0.524 ± 0.010 | 0.291 |
| Aldomi GRU-KNN | 0.940 ± 0.001 | 0.828 ± 0.015 | 0.607 ± 0.009 | 0.662 ± 0.009 | 0.724 ± 0.072 | 0.496 ± 0.022 | 0.047 |

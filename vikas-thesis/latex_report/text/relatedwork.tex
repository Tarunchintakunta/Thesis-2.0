...
Prior work such as Nguyen et al. (2025) laid foundations, but Prior work evaluates latency bounds theoretically. This research empirically injects network partitioning to measure read-stall degradation.

In reference to Morgan (2025), the integration highlights a distinct improvement metric.
...
As noted in Wood (2025), scalability remains paramount. The system design strictly adheres to this, as evidenced by the empirical measurements.
...
In reference to Ramos & Kim (2026), the integration highlights a distinct improvement metric.

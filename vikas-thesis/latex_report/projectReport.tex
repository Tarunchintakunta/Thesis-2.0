...
\newcommand{\myname}{Vikas Reddy Amanagantti}
\newcommand{\studentID}{X25178849}
\newcommand{\mytitle}{An Empirical Evaluation of Application-Level Idempotency Strategies for Retry Correctness on AWS Lambda and Amazon DynamoDB}

\newcommand{\supervisor}{TBD}
\newcommand{\supervisortwo}{N/A} % for Internship with a clear supervisor only!

...
Prior work such as Shen et al. (2025) and Yang et al. (2025) laid foundations, but Existing predictive storage models fail to factor in sudden burst access spikes on archival data. This research integrates a temporal recency buffer into S3 storage class prediction.
